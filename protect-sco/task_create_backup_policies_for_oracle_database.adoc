...
See link:task_view_oracle_databse_backups_and_clones_in_the_topology_page.html[View Oracle database backups and clones in the Topology page].
a|
...
+
SnapCenter allows you to use the predefined environment variables when you execute the prescript and postscript. link:predefined-environment-variables-prescript-postscript-backup.html[Learn more^]
