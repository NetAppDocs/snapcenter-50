...
You can also use PowerShell cmdlets manually or in scripts to perform backup and restore operations. For detailed information about PowerShell cmdlets, use the SnapCenter cmdlet help or see https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmll[SnapCenter Software Cmdlet Reference Guide^].
