...
NOTE: From SnapCenter 5.0, vserver admin users are only supported with REST APIs. If you want to create roles using non vserver admin, you should use ZAPI.
