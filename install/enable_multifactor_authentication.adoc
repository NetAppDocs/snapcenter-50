...
* The information regarding the parameters that can be used with the cmdlet and their descriptions can be obtained by running `Get-Help command_name`. Alternatively, you can also see https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmlll[SnapCenter Software Cmdlet Reference Guide^].
