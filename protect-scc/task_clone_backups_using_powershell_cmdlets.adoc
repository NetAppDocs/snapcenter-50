...
For information about PowerShell cmdlets, use the SnapCenter cmdlet help or see the https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmlll[SnapCenter Software Cmdlet Reference Guide^].
